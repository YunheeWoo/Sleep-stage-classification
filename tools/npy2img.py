...
src_path = Path("/data/hdd1/dataset/Seoul_dataset/9channel_prefilter_mne/signals/")
#dst_path = Path("/home/eslab/wyh/data/img/")
dst_path = Path("/home/eslab/wyh/data/img/Verif/mne/")
