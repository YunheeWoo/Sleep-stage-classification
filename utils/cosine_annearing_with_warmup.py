...
class LearningRateWarmUP_restart_changeMax(object):
    def __init__(self, optimizer, warmup_iteration=5, cosine_decay_iter=45, target_lr=0.1, gamma=0.8,after_scheduler=None):
    ...
    def step(self, cur_iteration):
        ...
        if (cur_iteration-(self.cur_iteration_decay*(self.warmup_iteration+self.cosine_decay_iter))) == 1:
            self.optimizer.param_groups[0]['initial_lr'] = self.target_lr
