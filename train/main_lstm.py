...
data_path = Path("/home/eslab/wyh/data/img/resize/1920x1080-448x224/t-02/mean-std-cut/")
cnn_checkpoint_name = 'Efficientb0-downsampling_full.pth'
#cnn_checkpoint_name = 'Efficientb0-10class.pth'
cnn_checkpoint_name = 'Efficientb0-10class-newmean-nonhorizon.pth'
...
trainset = SleepDataLSTMset("/home/eslab/wyh/train_downsampling_full.csv", data_path, signals, inv=False, color="L", train=False,#shuffle=True,
...
valset = SleepDataLSTMset("/home/eslab/wyh/val_downsampling.csv", data_path, signals, inv=False, color="L", #shuffle=True,
                            transform=transforms.Compose([
                                    #transforms.Resize([224,224]),
                                    transforms.ToTensor(), 
                                    transforms.Normalize(mean=[0.1551], std=[0.1427]),
...
testset = SleepDataLSTMset("/home/eslab/wyh/test_downsampling.csv", data_path, signals, inv=False, color="L", #shuffle=True,
                            transform=transforms.Compose([
                                    #transforms.Resize([224,224]),
                                    transforms.ToTensor(), 
                                    transforms.Normalize(mean=[0.1551], std=[0.1427]),
...
net = EfficientNet.from_pretrained('efficientnet-b0', in_channels=1, num_classes=10)
#net = resnet50_grayscale()
lstm = BiLSTM(input_size=1280, hidden_size=512, seq_length=5, batch_size=batch_size, num_classes=10)
