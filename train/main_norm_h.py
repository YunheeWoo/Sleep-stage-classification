...
trainset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_h_C3-M2,E2-M1,E1-M2/train',transform=transforms.Compose([
                               transforms.Resize([1920,30]), 
...
testset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_h_C3-M2,E2-M1,E1-M2/test',transform=transforms.Compose([
                               transforms.Resize([1920,30]), 
                               transforms.RandomHorizontalFlip(),
                               transforms.ToTensor(), 
                               transforms.Normalize(mean=[0.9755, 0.9819, 0.9867],
...
valset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_h_C3-M2,E2-M1,E1-M2/val',transform=transforms.Compose([
                               transforms.Resize([1920,30]), 
                               transforms.RandomHorizontalFlip(),
                               transforms.ToTensor(), 
                               transforms.Normalize(mean=[0.9755, 0.9819, 0.9867],
...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/Normal_h_3over4_h.pth')
...
def valid(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/Normal_h_3over4_h.pth')
        best_acc = acc
