...
class ResNet_dropout_grayscale(nn.Module):
    ...
    def __init__(
        ...
        super(ResNet_dropout_grayscale, self).__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
        self._norm_layer = norm_layer
...
def _resnet_dropout_grayscale(
    ...
    progress: bool,
    **kwargs: Any
) -> ResNet_dropout_grayscale:
    model = ResNet_dropout_grayscale(block, layers, **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls[arch],
                                              progress=progress)
        model.load_state_dict(state_dict)
...
def resnet18_dropout_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_dropout_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_dropout_grayscale('resnet18', BasicBlock_dropout, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet34_dropout_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_dropout_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_dropout_grayscale('resnet34', BasicBlock_dropout, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet50_dropout_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_dropout_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_dropout_grayscale('resnet50', Bottleneck_dropout, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet101_dropout_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_dropout_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_dropout_grayscale('resnet101', Bottleneck_dropout, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)
...
def resnet152_dropout_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_dropout_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_dropout_grayscale('resnet152', Bottleneck_dropout, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)