...
def _resnet_grayscale(
    ...
    **kwargs: Any
    ...
    model = ResNet_grayscale(block, layers, **kwargs)
    if pretrained:
        state_dict = load_state_dict_from_url(model_urls[arch],
                                              progress=progress)
        model.load_state_dict(state_dict)
...
def resnet18_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_grayscale('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet34_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_grayscale('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet50_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_grayscale('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet101_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_grayscale('resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)
...
def resnet152_grayscale(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> ResNet_grayscale:
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_grayscale('resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)