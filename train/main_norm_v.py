...
trainset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_v_C3-M2,E2-M1,E1-M2/train',transform=transforms.Compose([
...
testset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_v_C3-M2,E2-M1,E1-M2/test',transform=transforms.Compose([
                               transforms.RandomHorizontalFlip(),
                               transforms.ToTensor(), 
                               transforms.Normalize(mean=[0.9755, 0.9819, 0.9867],
                                     std=[0.1405, 0.1195, 0.1016])
...
valset = ImageFolder(root='/home/eslab/wyh/medical/data/SNU/img/1920x40/Con_v_C3-M2,E2-M1,E1-M2/val',transform=transforms.Compose([
                               transforms.RandomHorizontalFlip(),
                               transforms.ToTensor(), 
                               transforms.Normalize(mean=[0.9755, 0.9819, 0.9867],
                                     std=[0.1405, 0.1195, 0.1016])
...
if args.resume:
    ...
    checkpoint = torch.load('./checkpoint/Normal_v.pth')
...
def valid(epoch):
    ...
    if acc > best_acc:
        ...
        if not os.path.isdir('checkpoint'):
            os.mkdir('checkpoint')
        torch.save(state, './checkpoint/Normal_v.pth')
        best_acc = acc
